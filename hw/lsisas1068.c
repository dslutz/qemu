                                ...
                                MptReplyUnion *reply)
{
    ...
    case MPT_MESSAGE_HDR_FUNCTION_FW_UPLOAD:
    {
        ...
        target_phys_addr_t iov_pa = p_fw_upload_req->sge.data_buf_addr_low;
        void *ptr;
...
static uint64_t mpt_mmio_read(void *opaque, target_phys_addr_t addr,
                              unsigned size)
{
    MptState *s = opaque;
    uint32_t retval = 0;
...
static void mpt_mmio_write(void *opaque, target_phys_addr_t addr,
...
static uint64_t mpt_port_read(void *opaque, target_phys_addr_t addr,
                              unsigned size)
{
    return mpt_mmio_read(opaque, addr & 0xff, size);
}

static void mpt_port_write(void *opaque, target_phys_addr_t addr,
                           uint64_t val, unsigned size)
{
...
static uint64_t mpt_diag_read(void *opaque, target_phys_addr_t addr,
                              unsigned size)
{
...
static void mpt_diag_write(void *opaque, target_phys_addr_t addr,
                           uint64_t val, unsigned size)
{
