...
static void machine_get_vmware_hw(Object *obj, Visitor *v,
                                       void *opaque, const char *name,
                                       Error **errp)
{
    int64_t value = vmware_hw;

    visit_type_int(v, &value, name, errp);
}

static void machine_set_vmware_hw(Object *obj, Visitor *v,
                                       void *opaque, const char *name,
                                       Error **errp)
{
    Error *error = NULL;
...
static void machine_initfn(Object *obj)
{
    ...
    object_property_add(obj, "vmware-hw", "int",
                        machine_get_vmware_hw,
                        machine_set_vmware_hw,
                        NULL, NULL, NULL);
}
